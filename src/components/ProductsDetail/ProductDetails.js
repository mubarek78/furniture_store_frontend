                        ...
                        <div className="col-lg-6">
                            <div className="product_detail_content">
                                    ...
                                    <div className="product_rating">
                                        ...
                                        <span className="review_number">({product.rating.count} Reviews)</span>
                                    </div>
                                    ...
                                    <div className="Product_link_btns">
                                        <button className='add_to_fav' onClick={() => addToFav(product.id)}><FaRegHeart size={16}/></button>
                                        <button className='add_to_cart' onClick={() => addToCart(product.id)}><FaShoppingCart size={20} />  Add To Cart </button>
